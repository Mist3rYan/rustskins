...
class OpenId {
  final steamLogin = 'https://steamcommunity.com/openid/login';
  ...
  static final RegExp validationRegexp =
  ...
  Future<String> validate() async {
    ...
    var resp = await http.post(Uri.parse(steamLogin), body: params);
    ...
    if (!validationRegexp.hasMatch(openIdUrl)) {
      throw OpenIdException(
          OpenIdFailReason.pattern, 'Invalid steam id pattern');
    }

    return validationRegexp.firstMatch(openIdUrl)!.group(1)!;
  }
